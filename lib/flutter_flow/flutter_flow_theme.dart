...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color transparent = const Color(0x0000000);
  late Color primary = const Color(0xFFFF0000);
  late Color secondary = const Color(0xFF39D2C0);
  late Color tertiary = const Color(0xFFEE8B60);
  late Color alternate = const Color(0xFFF3F3F3);
  ...
  late Color warning = const Color(0xFFF6A000);
  late Color error = const Color(0xFFFF5963);
  late Color info = const Color(0xFFFFEBC5);
}
